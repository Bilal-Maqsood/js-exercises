...
console.log('George Bernard Shaw once said, "We dont stop playing because we grow old; we grow old because we stop playing."');

let famous_person = 'George Bernard Shaw';
...
console.log('sum is:', sum(51, 3));
console.log('subtract is:', subtract(2, 4));
console.log('multiply is:', multiply(25, 4));
console.log('divide is:', divide(64, 2));
...
let GuestList = ['Hassan', 'Adil', 'Zai', 'Bilal'];
...
// it has, print a message that the person will need to enter a new username. If a username has not
// been used, print a message saying that the username is available.
// Make sure your comparison is case insensitive. If 'John' has been used, 'JOHN' should not be accepted.

const current_users = ['Adil', 'Mike', 'Tammy', 'Bilal', 'Hassan'];
const new_users = ['A1', 'Adil', 'MIKE', 'U4', 'Bilal'];
